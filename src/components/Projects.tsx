            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group block border-b border-border/50 py-8 md:py-10 cursor-pointer hover:bg-secondary/20 transition-colors duration-300 px-4 -mx-4 rounded-lg"
                >
